...
public class warriorBattle10 extends JFrame
{
	...
	private Random burnChance = new Random();
	...
	private void createUserInterface()
	{
		...
		HPJTextField.setText(String.valueOf(280));
	...
	private void load()
	{
		enemyLVLJTextField.setText("60");
		LVLJTextField.setText("55");
		classJTextField.setText("Warrior");
		enemyNameJTextField.setText("Pyromancer");
	...
	{	
		...
		int bc = burnChance.nextInt(4) + 1;
		
		String HP = HPJTextField.getText();

		int dmg = incomingDMG.nextInt(20) + 110;
		...
		if(stat.equals(""))
		{
			...
			if(bc <= 1)
			{
				JOptionPane.showMessageDialog(null, ename + " attacks you with a fire spell for " + dmg + " damage!! You are left with a burn.");
	...
	private void enemyAttackBlocked()
	{
		...
		if(stat.equals(""))
		{
			...
			if(dmg <= b)
			{
				...
				if(bc <= 1)
				{
					JOptionPane.showMessageDialog(null, ename + " attacks you with a fire spell for " + dmg + " damage, but you blocked " + b + " damage! You are left with a burn.");
	...
	public static void WB10()
	{
		warriorBattle10 application = new warriorBattle10();
