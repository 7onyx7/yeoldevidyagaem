...
public class warriorBattle7 extends JFrame
{
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(enemyHP.nextInt(20) + 200));
		...
		HPJTextField.setText(String.valueOf(220));
	...
	private void load()
	{
		enemyLVLJTextField.setText("35");
		LVLJTextField.setText("35");
		classJTextField.setText("Warrior");
		
		int ename = enemyName.nextInt(4);
			
			switch(ename)
			{
				case 0:
				enemyNameJTextField.setText("Minotaur");
				break;
				
				case 1:
				enemyNameJTextField.setText("Cyclops");
				break;
				
				case 2:
				enemyNameJTextField.setText("Undead");
				break;
				
				case 3:
				enemyNameJTextField.setText("Bandit");
				break;
	...
	private void enemyAttack()
	{
		...
		int dmg = incomingDMG.nextInt(20) + 70;
	...
	public static void WB7()
	{
		warriorBattle7 application = new warriorBattle7();
