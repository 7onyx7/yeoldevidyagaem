...
public class warriorBattle8 extends JFrame
{
	...
	private Random lichCurseChance = new Random();
	...
	private void createUserInterface()
	{
		...
		HPJTextField.setText(String.valueOf(240));
	...
	private void load()
	{
		enemyLVLJTextField.setText("50");
		LVLJTextField.setText("40");
		classJTextField.setText("Warrior");
		enemyNameJTextField.setText("Lich");
	...
	{	
		...
		int lcc = lichCurseChance.nextInt(4) + 1;
		
		String HP = HPJTextField.getText();

		int dmg = incomingDMG.nextInt(30) + 90;
		...
		if(stat.equals(""))
		{
			...
			if(lcc <= 1)
			{
				JOptionPane.showMessageDialog(null, ename + " attacks you with a curse of death for " + dmg + " damage!! You are now cursed...");
	...
	private void enemyAttackBlocked()
	{
		...
		if(stat.equals(""))
		{
			...
			if(dmg <= b)
			{
				...
				if(lcc <= 1)
				{
					JOptionPane.showMessageDialog(null, ename + " attacks you with a curse of death for " + dmg + " damage, but you blocked " + b + " damage! You are now cursed...");
	...
	public void lichCurseEffect()
	{	
		String HP = HPJTextField.getText();
		String stat = SEJTextField.getText();
		int crsDMG = curse.nextInt(5) + 5;
	...
	public static void WB8()
	{
		warriorBattle8 application = new warriorBattle8();
