...
public class warriorBattle9 extends JFrame
{
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(300));
		...
		HPJTextField.setText(String.valueOf(260));
	...
	private void load()
	{
		enemyLVLJTextField.setText("55");
		LVLJTextField.setText("50");
		classJTextField.setText("Warrior");
		enemyNameJTextField.setText("Cryomancer");
	...
	private void att1JButtonActionPerformed(ActionEvent event)
	{
		...
		int dmg = generator.nextInt(10) + 25;
		...
		else
		{
			...
			int dmg2 = generator.nextInt(20) + 25;
			...
			else
			{
				...
				int dmg3 = generator.nextInt(30) + 25;
	...
	{	
		int ccc = generator.nextInt(4) + 1;
		
		int disable = generator.nextInt(9) + 1;
		
		int dmg = generator.nextInt(20) + 60;
		...
		int which = generator.nextInt(2) + 1;
		...
		if(stat.equals(""))
		{
			...
			if(ccc <= 2)
			{
				SEJTextField.setText("Frostbite");
				
				JOptionPane.showMessageDialog(null, ename + " attacks you with a frost spell for " + dmg + " damage!! You now have Frostbite.");
	...
	private void enemyAttackBlocked()
	{
		...
		if(stat.equals(""))
		{
			...
			if(dmg <= b)
			{
				...
				if(ccc <= 2)
				{
					JOptionPane.showMessageDialog(null, ename + " attacks you with a frost spell for " + dmg + " damage, but you blocked " + b + " damage! You now have Frostbite.");
	...
	{	
		String HP = HPJTextField.getText();
		String stat = SEJTextField.getText();
		int cccDMG = generator.nextInt(5) + 10;
		int remHP = Integer.parseInt(HP) - cccDMG;
		int disable = generator.nextInt(9) + 1;
		...
		{
			JOptionPane.showMessageDialog(null, "You took " + cccDMG + " Frostbite damage!");
	...
	{		
		...
		String HP = HPJTextField.getText();
		int clear = generator.nextInt(9) + 1;
		...
		if(clear == 1)
		{
			...
			JOptionPane.showMessageDialog(null, "The coldness fades away as Frostbite affects you no more.");
	...
	public static void WB9()
	{
		warriorBattle9 application = new warriorBattle9();
