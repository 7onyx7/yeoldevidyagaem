...
public class warriorBattle5 extends JFrame
{
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(enemyHP.nextInt(20) + 160));
		...
		HPJTextField.setText(String.valueOf(180));
	...
	private void load()
	{
		enemyLVLJTextField.setText("25");
		LVLJTextField.setText("25");
	...
	private void enemyAttack()
	{
		...
		int dmg = incomingDMG.nextInt(20) + 50;
	...
	public static void WB5()
	{
		warriorBattle5 application = new warriorBattle5();
