...
public class warriorBattle4 extends JFrame
{
	...
	private Random burn = new Random();
	
	private Random dragonBurnChance = new Random();
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(enemyHP.nextInt(20) + 180));
		...
		HPJTextField.setText(String.valueOf(160));
	...
	private void load()
	{
		enemyLVLJTextField.setText("20");
		LVLJTextField.setText("15");
		classJTextField.setText("Warrior");
		enemyNameJTextField.setText("Dragon");
	...
	{	
		...
		int dbc = dragonBurnChance.nextInt(4) + 1;
		
		String HP = HPJTextField.getText();

		int dmg = incomingDMG.nextInt(40) + 50;
		...
		if(stat.equals(""))
		{
			...
			if(dbc <= 1)
			{
				JOptionPane.showMessageDialog(null, ename + " attacks you with a breath of fire for " + dmg + " damage!! You are left with a burn.");
	...
	private void enemyAttackBlocked()
	{
		...
		if(stat.equals(""))
		{
			...
			if(dmg <= b)
			{
				...
				if(dbc <= 1)
				{
					JOptionPane.showMessageDialog(null, ename + " attacks you with a breath of fire for " + dmg + " damage, but you blocked " + b + " damage! You are left with a burn.");
	...
	public void dragonBurnEffect()
	{	
		String HP = HPJTextField.getText();
		String stat = SEJTextField.getText();
		int brnDMG = burn.nextInt(5) + 5;
		int remHP = Integer.parseInt(HP) - brnDMG;
		HPJTextField.setText(String.valueOf(remHP));
		...
		{
			JOptionPane.showMessageDialog(null, "You took " + brnDMG + " burn damage!");
			HPJTextField.setText(String.valueOf(remHP));
	...
	public void status()
	{
		...
		else if(clear == 1)
		{
			...
			JOptionPane.showMessageDialog(null, "The burn's lingering effect plagues you no more!");
				
		}
		
	}
	
	public static void WB4()
	{
		warriorBattle4 application = new warriorBattle4();
