...
public class warriorBattle1 extends JFrame
{
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(enemyHP.nextInt(20) + 100));
		...
		HPJTextField.setText(String.valueOf(100));
	...
	private void load()
	{
		enemyLVLJTextField.setText("1");
		LVLJTextField.setText("1");
	...
	private void enemyAttack()
	{
		...
		int dmg = incomingDMG.nextInt(20) + 20;
	...
	public static void WB1()
	{
		warriorBattle1 application = new warriorBattle1();
