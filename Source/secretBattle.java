...
public class secretBattle extends JFrame
{
	...
	private void createUserInterface()
	{
		...
		enemyHPJTextField.setText(String.valueOf(1000000));
		...
		HPJTextField.setText(String.valueOf(100000));
	...
	private void load()
	{
		enemyLVLJTextField.setText("1000000");
		LVLJTextField.setText("1000");
		classJTextField.setText("Warrior");
		enemyNameJTextField.setText("Filthy Frank");
	...
	private void att1JButtonActionPerformed(ActionEvent event)
	{
		...
		int dmg = slash.nextInt(50000) + 1;
		int reh = Integer.parseInt(enemyHealth) - dmg;
		
		JOptionPane.showMessageDialog(null, "You slash " + ename + " for " + dmg + " damage!");
		
		enemyHPJTextField.setText(String.valueOf(reh));
		
		if(reh <= 0)
		{
			JOptionPane.showMessageDialog(null, "NO BOSS PLEASE PLEEASSEE NOOOOO");
		...
		else
		{
			...
			int dmg2 = slash.nextInt(50000) + 1;
			int reh2 = Integer.parseInt(enemyHealth2) - dmg2;
			
			JOptionPane.showMessageDialog(null, "You slash " + ename + " again for " + dmg2 + " damage!!");
			...
			else
			{
				...
				int dmg3 = slash.nextInt(100000) + 1;
				int reh3 = Integer.parseInt(enemyHealth3) - dmg3;
				
				JOptionPane.showMessageDialog(null, "You slash " + ename + " once more for " + dmg3 + " damage!!");
	...
	private void att2JButtonActionPerformed(ActionEvent event)
	{
		...
		if(stun <= 2)
		{
			...
			JOptionPane.showMessageDialog(null, "You bash " + ename + " with your shield for " + dmg + " damage, leaving him stunned!");
		...
		else
		{
			...
			JOptionPane.showMessageDialog(null, "You bash " + ename + " with your shield for " + dmg + " damage.");
	...
	{	
		...
		int dmg = incomingDMG.nextInt(10000) + 1;
		...
		if(stat.equals(""))
		{
			...
			if(ccc <= 1)
			{
				JOptionPane.showMessageDialog(null, ename + " traumatizes you, causing " + dmg + " damage!!");
				...
				if((int) remHP <= 0)
				{
					...
					JOptionPane.showMessageDialog(null, "GET OUT OF MY HOUSE YOU FILTHY WEEABOO");
			...
			{
				JOptionPane.showMessageDialog(null, ename + " attacks you, inflicting " + dmg + " damage!!");
	...
	private void enemyAttackBlocked()
	{
		...
		if(stat.equals(""))
		{
			...
			if(dmg <= b)
			{
				...
				if(ccc <= 1)
				{
					JOptionPane.showMessageDialog(null, ename + " traumatizes you, causing " + dmg + " damage, but you blocked " + b + " damage!");
				...
				{
					JOptionPane.showMessageDialog(null, ename + " attacks you, inflicting " + dmg + " damage, but you blocked " + b + " damage!");
	...
	{	
		...
		String HP = HPJTextField.getText();
		String stat = SEJTextField.getText();
		int statDMG = chaos.nextInt(50000) + 5000;
	...
	public static void SWB()
	{
		secretBattle application = new secretBattle();
